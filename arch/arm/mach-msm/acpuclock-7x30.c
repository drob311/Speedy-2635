...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
        ...
        { 825600, PLL_2,    3, 0,  192000, 950, VDD_RAW(950) },
        { 844800, PLL_2,    3, 0,  192000, 950, VDD_RAW(950) },
        { 864000, PLL_2,    3, 0,  192000, 950, VDD_RAW(950) },
        { 883200, PLL_2,    3, 0,  192000, 950, VDD_RAW(950) },
        { 902400, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 921600, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 940800, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 960000, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 979200, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 998400, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 1017600, PLL_2,   3, 0,  192000, 1000, VDD_RAW(1000) },
        { 1036800, PLL_2,   3, 0,  192000, 1000, VDD_RAW(1000) },
        { 1056000, PLL_2,   3, 0,  192000, 1000, VDD_RAW(1000) },
        { 1075200, PLL_2,   3, 0,  192000, 1025, VDD_RAW(1025) },
        { 1094400, PLL_2,   3, 0,  192000, 1025, VDD_RAW(1025) },
        ...
        { 1171200, PLL_2,   3, 0,  192000, 1075, VDD_RAW(1075) },
        { 1190400, PLL_2,   3, 0,  192000, 1100, VDD_RAW(1100) },
        { 1209600, PLL_2,   3, 0,  192000, 1100, VDD_RAW(1100) },
        { 1228800, PLL_2,   3, 0,  192000, 1125, VDD_RAW(1125) },
        { 1248000, PLL_2,   3, 0,  192000, 1125, VDD_RAW(1125) },
        { 1267200, PLL_2,   3, 0,  192000, 1150, VDD_RAW(1150) },
        { 1286400, PLL_2,   3, 0,  192000, 1150, VDD_RAW(1150) },
        { 1305600, PLL_2,   3, 0,  192000, 1175, VDD_RAW(1175) },
        { 1324800, PLL_2,   3, 0,  192000, 1175, VDD_RAW(1175) },
        { 1344000, PLL_2,   3, 0,  192000, 1200, VDD_RAW(1200) },
        { 1363200, PLL_2,   3, 0,  192000, 1225, VDD_RAW(1225) },
        ...
        { 1440000, PLL_2,   3, 0,  192000, 1300, VDD_RAW(1300) },
        { 1459200, PLL_2,   3, 0,  192000, 1300, VDD_RAW(1300) },
        { 1478400, PLL_2,   3, 0,  192000, 1325, VDD_RAW(1325) },
        { 1497600, PLL_2,   3, 0,  192000, 1350, VDD_RAW(1350) },
        { 1516800, PLL_2,   3, 0,  192000, 1350, VDD_RAW(1350) },
        { 1555200, PLL_2,   3, 0,  192000, 1375, VDD_RAW(1375) },
        { 1612800, PLL_2,   3, 0,  192000, 1400, VDD_RAW(1400) },
        { 1651200, PLL_2,   3, 0,  192000, 1400, VDD_RAW(1400) },
        { 1708800, PLL_2,   3, 0,  192000, 1425, VDD_RAW(1425) },
        { 1747200, PLL_2,   3, 0,  192000, 1450, VDD_RAW(1450) },
        { 1804800, PLL_2,   3, 0,  192000, 1450, VDD_RAW(1450) },
        { 1843200, PLL_2,   3, 0,  192000, 1475, VDD_RAW(1475) },
	{ 1939200, PLL_2,   3, 0,  192000, 1500, VDD_RAW(1500) },
